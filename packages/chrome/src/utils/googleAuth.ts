 ...
 */
export function getLoginUrl(redirectUri: any) {
 ...
 */
export function isSignInRedirect(redirectUri: string) {
  // Check if current url matches redirect uri
 ...
 */
function createQueryParams(params: { [x: string]: any; app_redirect?: any }) {
